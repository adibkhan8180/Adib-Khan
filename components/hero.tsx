  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 md:px-6 overflow-hidden">
      ...
      <div className={`transition-opacity duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
        ...
        >
          <div className="inline-block relative">
            ...
            <div className="relative bg-background/80 backdrop-blur-sm rounded-full p-4 border border-primary/20">
              <h3 className="text-sm md:text-base font-medium">Full Stack MERN Developer</h3>
            </div>
          </div>
        </motion.div>

        <AnimatedText text="Hi, I'm John Doe" className="text-4xl md:text-6xl font-bold mb-4" />
        ...
        >
          I build modern, responsive web applications with MongoDB, Express, React, and Node.js
        </motion.p>
        ...
        >
          <Button size="lg" onClick={handleDownloadCV} className="relative overflow-hidden group">
